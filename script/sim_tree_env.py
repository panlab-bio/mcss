# -*- coding: utf-8 -*-
# Generate the simulated tree based on env.
# The input consists of the simulation path, script path, number of species, and environmental information.
import numpy as np
import pandas as pd
import itertools
import subprocess
...
# The minimum and maximum number of species.
cnt_sp_70 = []
...
cnt_sub_tree = 0 #Record the number of subtrees obtained.
